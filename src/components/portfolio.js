...
const sampleItems = [
  ...
  { id: 2, title: 'Dashboard UI', desc: 'Interactive charts and tables with filters.' },
  { id: 3, title: 'Component Library', desc: 'Reusable components and theming.' },
];

export default function Portfolio({ items = sampleItems }) {
  return (
    <Box component="section" sx={{ py: { xs: 6, md: 8 } }}>
      <Container maxWidth="lg">
        <Typography variant="overline" color="text.secondary">Portfolio</Typography>
        <Typography variant="h4" sx={{ fontWeight: 800, mt: 0.5, mb: 3 }}>Featured Work</Typography>
